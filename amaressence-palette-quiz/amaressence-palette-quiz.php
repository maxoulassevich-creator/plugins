...
require_once APQ_PLUGIN_DIR . 'includes/class-apq-popup.php';
...
final class APQ_Plugin {
	...
	public function __construct() {
		...
		$this->quiz    = new APQ_Quiz( $this->settings, $this->logger, $this->results, $this->points );
		$this->popup   = new APQ_Popup( $this->settings, $this->logger );
